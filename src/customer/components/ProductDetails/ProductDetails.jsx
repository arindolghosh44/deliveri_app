        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-h-[7rem] max-w-[7rem] mt-4 mb-1">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pd-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl text-left font-semibold  text-gray-900 ">
                causual puff the
              </h1>
              <h1 className="text-lg lg:text-xl  text-left text-gray-900 opacity-60 pt-1 ">
                Duff the thro hdhddh sgssg{" "}
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className=" font-semibold">RS.277</p>
                <p className="opacity-50 line-through">RS.344</p>
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating name="read-only" value={5.6} readOnly />
              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-12 lg:grid-cols-8">
...
<div onClick={handleAddToCart} className="mt-3 text-left"> <Button  variant="contained" sx={{px:"2rem",py:"1rem",bgcolor:"#9155fd"}} >
